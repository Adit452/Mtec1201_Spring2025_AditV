...
// adding a moon at night
if (r < 50 && g < 50 && b < 80) { 
// Glow effect
noStroke();
fill(255, 255, 255, 50); // Semi-transparent white for glow
ellipse(width - 600, 100, 220, 220); // Larger circle for glow

drawMoon(width-600,100)
}
